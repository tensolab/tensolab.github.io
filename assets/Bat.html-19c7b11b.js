import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,e as s}from"./app-2ea8cdd2.js";const d={},a=s(`<h1 id="bat" tabindex="-1"><a class="header-anchor" href="#bat" aria-hidden="true">#</a> Bat</h1><p><strong>Bat脚本</strong>(Batch Script，也叫批处理脚本)是windows系统下一种以<code>.bat</code>或<code>.cmd</code>为扩展名的脚本文件，用于<strong>自动化执行一系列命令</strong>。是基于Windows命令行(CMD)的一种脚本语言。</p><h2 id="cmd-命令提示符" tabindex="-1"><a class="header-anchor" href="#cmd-命令提示符" aria-hidden="true">#</a> CMD(命令提示符)</h2><h3 id="cd-切换目录" tabindex="-1"><a class="header-anchor" href="#cd-切换目录" aria-hidden="true">#</a> cd 切换目录</h3><p>主要用于显示或切换当前目录</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>// 不带参数时会显示当前所在的工作目录
